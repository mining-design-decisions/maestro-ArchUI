...
def viewall():
    ontologies = o_data.get_ontologies()
...
def create():
    ...
    data, status = o_data.upload_ontology(request.form.get('desc'), file_binary)
    if status == 200:
