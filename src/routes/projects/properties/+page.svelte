...
import GreenButton from "$lib/components/GreenButton.svelte";
  ...
  import TextInputTable from "$lib/components/TextInputTable.svelte";
	...
	const addProperty = async () => {
		...
		postRequest(`/projects/${data.id}/properties`, body, () => alert("Property added!"))
	}
	...
	const updateProperty = async (id: string, name: string, value: string) => {
		...
		putRequest(`/projects/${data.id}/properties/${id}`, body, () => alert("Property updated!"))
	}

	const deleteProperty = async (id: string) => {
		deleteRequest(`/projects/${data.id}/properties/${id}`, () => alert("Property deleted!"))
	}
</script>
