...
<div>
	<div class="container mx-auto pb-4 pl-4 pr-4">
	<div>
		<p class="text-4xl font-bold pb-4">Home Page</p>
		<p>
	...
	<div class="grid grid-cols-1 md:grid-cols-2 gap-4 mx-auto">
		<div>
		<div>
			<p class="text-xl font-bold">ML Models: Word Embeddings</p>
			<p>
		...
		<div>
			<p class="text-xl pt-4 font-bold">Managing ML Models</p>
			<p>
		...
		<div>
			<p class="text-xl pt-4 font-bold">Login</p>
			<p>
		...
		<div>
			<p class="text-xl pt-4 font-bold">ML Models: Ontologies</p>
			<p>
		...
		<div>
		<div>
			<p class="text-xl font-bold">ML Models: Predicting</p>
			<p>
		...
		<div>
			<p class="text-xl pt-4 font-bold">Classify Issues</p>
			<p>
		...
		<div>
			<p class="text-xl pt-4 font-bold">Statistics</p>
			<p>
		...
		<div>
			<p class="text-xl pt-4 font-bold">Tags</p>
			<p>
		...
		<div>
			<p class="text-xl pt-4 font-bold">Search</p>
